...
```{r}
round(cor(MSOA_London$NP, MSOA_London$res), 2) # 0.15
round(cor(MSOA_London$NP, MSOA_London$wd), 2) # 0.86
```
...
```{r}
round(cor(LSOA_London$NP, LSOA_London$res), 2) # 0.14
round(cor(LSOA_London$NP, LSOA_London$wd), 2) # 0.82
```
