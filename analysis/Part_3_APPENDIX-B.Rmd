...
```{r PlotYear2008, fig.height=12, fig.width=15, message=FALSE, warning=FALSE}
plor_year(2008, ct)
```
...
```{r PlotYear2010, fig.height=12, fig.width=15, message=FALSE, warning=FALSE}
plor_year(2010, ct)
```

```{r PlotYear2011, fig.height=12, fig.width=15, message=FALSE, warning=FALSE}
plor_year(2011, ct)
```
